            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xl text-lavender-700 dark:text-lavender-300 font-medium">
                  An open workflow framework for managing changelogs through
            ...
            <div className="rounded-lg border bg-card p-8 shadow-md happy-card">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Happy Changelog moves entries to PR descriptions and
                    automates the rest:
                  </p>
                  <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-md happy-card transform transition-transform hover:scale-105">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Add a "Changelog" section to your pull request description
                  with appropriate change categories (Added, Changed, Fixed,
                  etc.) and indicate the change level (major/minor/patch).
                </p>
              </div>
            </div>
              ...
              <div className="space-y-2 p-6 rounded-lg border bg-white dark:bg-card shadow-md happy-card">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Since changelog entries are added to PR descriptions
                      rather than directly to the CHANGELOG.md file, merge
                      conflicts on the changelog become a thing of the past.
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-2 p-6 rounded-lg border bg-white dark:bg-card shadow-md lavender-card">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      By specifying the change level (major/minor/patch) in the
                      PR description, the framework automatically determines the
              ...
              <div className="space-y-2 p-6 rounded-lg border bg-white dark:bg-card shadow-md sunny-card">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Follows the widely-adopted Keep a Changelog format,
                      ensuring consistency across all entries and making
                      changelogs more readable for users.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      messages, resulting in more meaningful and useful
                      changelog entries that better explain the changes to
                      users.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      releases automatically, saving time and ensuring
                      consistency between your changelog and release notes.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4 p-6 rounded-lg border bg-white dark:bg-card shadow-md happy-card">
              ...
              <ol className="list-decimal pl-5 space-y-2 text-muted-foreground">
                ...
                <li>
                  Determining the appropriate version bump based on change
                  levels
                </li>
                <li>Updating the CHANGELOG.md file with the new entries</li>
                <li>
                  Updating version numbers in relevant files (package.json,
                  etc.)
                </li>
          ...
          <div className="mx-auto max-w-5xl mt-8">
            <div className="rounded-lg border bg-white dark:bg-card p-6 shadow-md sunny-card">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Happy Changelog is a workflow framework, not a specific tool.
            ...
            <div className="rounded-lg border bg-white dark:bg-card p-8 shadow-md happy-card">
              <div className="space-y-4">
                <p className="text-lg text-muted-foreground italic">
                  ...
                  liked formalized commit messages in PRs. So I decided to
                ...
                <ul className="space-y-3 list-disc pl-5 text-muted-foreground">
                  ...
                  <li>
                    ...
                    changelogs and see clear version differences based on
                    selected version ranges.
                    <div className="mt-1">
                      <Link
